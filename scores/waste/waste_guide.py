...
def ai_disposal(prod_name, lga_url):
    ...
    x = gpt.get_response("First classify this" + prod_name + "into a general category on the following website then use information from this site to tell me what I should do with it:" + lga_url )
    return x
