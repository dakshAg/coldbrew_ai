...
def image_search(image_path):
    ...
    search_by_image_icon = driver.find_element(By.XPATH,
                                               "/html/body/div[1]/div[3]/form/div[1]/div[1]/div[1]/div/div[3]/div[3]")
    ...
    paste_image_link_option = driver.find_element(By.XPATH,
                                                  '//*[@id="ow6"]/div[3]/c-wiz/div[2]/div/div[3]/div[2]/c-wiz/div[2]/input')
    ...
    top5_search_results = []
    for i in range(1, 6):
        href_result = driver.find_element(By.XPATH,
                                          '//*[@id="yDmH0d"]/c-wiz/div/div[2]/div/c-wiz/div/div[2]/div/div/div/div[1]/div/div[3]/div[2]/div/div/div/div[1]/div[{}]/div/a'.format(
                                              i))
        url = href_result.get_attribute("href")
        image_result = driver.find_element(By.XPATH,
                                           '//*[@id="yDmH0d"]/c-wiz/div/div[2]/div/c-wiz/div/div[2]/div/div/div/div[1]/div/div[3]/div[2]/div/div/div/div[1]/div[{}]/div/a/div'.format(
                                               i))
